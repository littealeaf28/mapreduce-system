...
func Map(filename string, contents string) []*pb.KeyValue {
	...
	kva := []*pb.KeyValue{}
	kva = append(kva, &pb.KeyValue{Key: "a", Value: "1"})
	kva = append(kva, &pb.KeyValue{Key: "b", Value: "1"})
	kva = append(kva, &pb.KeyValue{Key: "c", Value: "1"})
	kva = append(kva, &pb.KeyValue{Key: "d", Value: "1"})
	kva = append(kva, &pb.KeyValue{Key: "e", Value: "1"})
	kva = append(kva, &pb.KeyValue{Key: "f", Value: "1"})
	kva = append(kva, &pb.KeyValue{Key: "g", Value: "1"})
	kva = append(kva, &pb.KeyValue{Key: "h", Value: "1"})
	kva = append(kva, &pb.KeyValue{Key: "i", Value: "1"})
	kva = append(kva, &pb.KeyValue{Key: "j", Value: "1"})
	return kva
}
